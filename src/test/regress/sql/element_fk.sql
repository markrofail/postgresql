...
REINDEX TABLE FKTABLEFORARRAYGIN;
VACUUM FKTABLEFORARRAYGIN; -- flush the fastupdate buffers
...
EXPLAIN (COSTS OFF) SELECT COUNT(*) FROM FKTABLEFORARRAYGIN WHERE ftest1 @>> 5;
